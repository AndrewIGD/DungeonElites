            ...
            foreach (player player in cameraFollow.playerScripts)
            {
                ...
                try
                {
                    if (player != null && (arrivePad != null ? arrivePad.input : true))
                    {
                        if (player.bot == false)
                        {
                            if (playerData.hasFocus && megamap.activeInHierarchy == false && ((player.gamePad != null ? (player.gamePad.rightStickPress == 1 && player.playerNumber != 5) : false) || ((Input.GetKey(KeyCode.I) && player.playerNumber == 5))))
                            {
                                ok = false;
                                if (canDo)
                                {
                            ...
                            if (playerData.hasFocus && ((player.gamePad != null ? (player.gamePad.back == 1 && player.playerNumber != 5) : false) || ((Input.GetKey(KeyCode.M) && player.playerNumber == 5))))
                            {
                                ok = false;
